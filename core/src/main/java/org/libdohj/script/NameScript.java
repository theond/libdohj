...
public class NameScript {
    ...
    public boolean isNameOp() {
        switch(op) {
            ...
            default:
                throw new ScriptException(ScriptError.SCRIPT_ERR_UNKNOWN_ERROR, "Invalid name op");
        }
    }
    ...
    public boolean isAnyUpdate() {
        switch(op) {
            ...
            default:
                throw new ScriptException(ScriptError.SCRIPT_ERR_UNKNOWN_ERROR, "Not a name op");
        }
    }
